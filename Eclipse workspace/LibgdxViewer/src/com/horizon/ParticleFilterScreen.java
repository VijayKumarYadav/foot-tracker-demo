...
public class ParticleFilterScreen implements Screen {
    ...
    public InitialisationController			initialisationController;
    ...
    public ParticleFilterScreen(OpeningInDoorsGame game) {
    	this.game = game;
        ...
        cam.position.set(20.0f, 14.0f, 0);
        cam.zoom = 0.05f;
    	...
    	initialisationController = new InitialisationController(game, cam, uiCam);
	...
	@Override
	public void show() {
		if(this.initialisationController == null){
			initialisationController = new InitialisationController(game, cam, uiCam);
		}
		Gdx.input.setInputProcessor(new GestureDetector(this.initialisationController));
	}
    ...
    private void handleInput() {
        if(Gdx.input.isKeyPressed(Input.Keys.BACK)) {
        	game.bluetoothInterface.sendMessage("reset\n");
